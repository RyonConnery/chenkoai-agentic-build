...
export const defaultPromptTemplates: PromptTemplate[] = [
  {
    ...
    user: [
      ...
      "- If this step needs to verify TypeScript or project health, propose workspace.run_project_check with target api, desktop, or all.",
      ...
      "",
      "Available tool names: workspace.list_files, workspace.read_text_file, workspace.write_text_file, workspace.run_project_check, workspace.git_status, workspace.git_diff.",
