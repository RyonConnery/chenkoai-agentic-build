...
export const defaultPromptTemplates: PromptTemplate[] = [
  {
    ...
    user: [
      ...
      "- If this step needs to ingest chosen content into ChenkoAI memory, propose workspace.content_ingestion_studio with datasetName, title, sourceKind, and either text or a workspace-relative path.",
      ...
      "",
      "Available tool names: workspace.list_files, workspace.read_text_file, workspace.write_text_file, workspace.run_project_check, workspace.git_status, workspace.git_diff, workspace.detect_development_tools, workspace.open_development_target, workspace.run_dev_task, workspace.content_ingestion_studio.",
      ...
      "Example content ingestion: {\"name\":\"workspace.content_ingestion_studio\",\"input\":{\"datasetName\":\"chenkoai-knowledge-base\",\"title\":\"Important Build Knowledge\",\"sourceKind\":\"pasted_text\",\"text\":\"Content to store.\",\"evaluationQuery\":\"What knowledge was added?\"}}",
      "",
