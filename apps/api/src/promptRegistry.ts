...
export const defaultPromptTemplates: PromptTemplate[] = [
  {
    ...
    user: [
      ...
      "",
      "Available tool names: workspace.list_files, workspace.read_text_file, workspace.write_text_file, workspace.run_project_check, workspace.git_status, workspace.git_diff, workspace.detect_development_tools, workspace.open_development_target, workspace.run_dev_task.",
